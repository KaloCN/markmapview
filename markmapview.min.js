...
/*d3-flextree.js*/ 
!function(n,e){"function"==typeof define&&define.amd?define(["d3"],e):"object"==typeof exports?module.exports=e(require("d3")):n.markmap=e(n.d3)}(this,function(n){function e(n,e){return n.parent==e.parent?1:2}function r(e,r){return n.rebind(e,r,"sort","children","value"),e.nodes=e,e.links=l,e}function l(e){return n.merge(e.map(function(n){return(n.children||[]).map(function(e){return{source:n,target:e}})}))}n.layout.flextree=function(){function l(n,e){var r=w.call(this,n,e),l=r[0],c=i(l);return N=c,t(c,0),d(c),x(c,0),g(c),r}function i(n){var e={t:n,prelim:0,mod:0,shift:0,change:0,msel:0,mser:0};if(n.x=0,n.y=0,j)e.x_size=1,e.y_size=1;else if("object"==typeof k)e.x_size=k[0],e.y_size=k[1];else{var r=k(n);e.x_size=r[0],e.y_size=r[1]}q&&(n.x_size=e.x_size,n.y_size=e.y_size);for(var l=[],t=n.children?n.children.length:0,c=0;t>c;++c)l.push(i(n.children[c]));return e.children=l,e.num_children=t,e}function t(n,e){n.t.y=e,n.t.depth=0,c(n)}function c(n){var e,r=n.t.y+n.y_size,l=n.t.depth+1;for(e=0;e<n.children.length;++e){var i=n.children[e];i.t.y=r,i.t.parent=n.t,i.t.depth=l,c(n.children[e])}}function d(n){if(0==n.num_children)return void u(n);d(n.children[0]);for(var e=y(f(n.children[0].el),0,null),r=1;r<n.num_children;++r){d(n.children[r]);var l=f(n.children[r].er);h(n,r,e),e=y(l,r,e)}p(n),u(n)}function u(n){0==n.num_children?(n.el=n,n.er=n,n.msel=n.mser=0):(n.el=n.children[0].el,n.msel=n.children[0].msel,n.er=n.children[n.num_children-1].er,n.mser=n.children[n.num_children-1].mser)}function h(n,e,r){for(var l=n.children[e-1],i=l.mod,t=n.children[e],c=t.mod;null!=l&&null!=t;){f(l)>r.lowY&&(r=r.nxt);var d=i+l.prelim-(c+t.prelim);null!=S?d+=S(l.t,t.t)*N.x_size:null!=Y&&(d+=l.x_size/2+t.x_size/2+Y(l.t,t.t)),d>0?(c+=d,o(n,e,r.index,d)):1===e&&0===c&&0===l.num_children&&t.num_children>1&&0>d&&(c+=d,o(n,e,r.index,d));var u=f(l),h=f(t);h>=u&&(l=s(l),null!=l&&(i+=l.mod)),u>=h&&(t=m(t),null!=t&&(c+=t.mod))}null==l&&null!=t?a(n,e,t,c):null!=l&&null==t&&_(n,e,l,i)}function o(n,e,r,l){n.children[e].mod+=l,n.children[e].msel+=l,n.children[e].mser+=l,v(n,e,r,l)}function m(n){return 0==n.num_children?n.tl:n.children[0]}function s(n){return 0==n.num_children?n.tr:n.children[n.num_children-1]}function f(n){return n.t.y+n.y_size}function a(n,e,r,l){var i=n.children[0].el;i.tl=r;var t=l-r.mod-n.children[0].msel;i.mod+=t,i.prelim-=t,n.children[0].el=n.children[e].el,n.children[0].msel=n.children[e].msel}function _(n,e,r,l){var i=n.children[e].er;i.tr=r;var t=l-r.mod-n.children[e].mser;i.mod+=t,i.prelim-=t,n.children[e].er=n.children[e-1].er,n.children[e].mser=n.children[e-1].mser}function p(n){n.prelim=(n.children[0].prelim+n.children[0].mod-n.children[0].x_size/2+n.children[n.num_children-1].mod+n.children[n.num_children-1].prelim+n.children[n.num_children-1].x_size/2)/2}function x(n,e){e+=n.mod,n.t.x=n.prelim+e,z(n);for(var r=0;r<n.num_children;r++)x(n.children[r],e)}function v(n,e,r,l){if(r!=e-1){var i=e-r;n.children[r+1].shift+=l/i,n.children[e].shift-=l/i,n.children[e].change-=l-l/i}}function z(n){for(var e=0,r=0,l=0;l<n.num_children;l++)e+=n.children[l].shift,r+=e+n.children[l].change,n.children[l].mod+=r}function y(n,e,r){for(;null!=r&&n>=r.lowY;)r=r.nxt;return{lowY:n,index:e,nxt:r}}function g(n){if(null!=j){for(var e,r=n,l=n,i=n,t=[n];e=t.pop();){var c=e.t;c.x<r.t.x&&(r=e),c.x>l.t.x&&(l=e),c.depth>i.t.depth&&(i=e),e.children&&(t=t.concat(e.children))}var d=null==S?.5:S(r.t,l.t)/2,u=d-r.t.x,h=j[0]/(l.t.x+d+u),o=j[1]/(i.t.depth>0?i.t.depth:1);for(t=[n];e=t.pop();){var c=e.t;c.x=(c.x+u)*h,c.y=c.depth*o,q&&(c.x_size*=h,c.y_size*=o),e.children&&(t=t.concat(e.children))}}else{var m=n.t.x;b(n,-m)}}function b(n,e){n.t.x+=e;for(var r=0;r<n.num_children;++r)b(n.children[r],e)}var w=n.layout.hierarchy().sort(null).value(null),S=e,Y=null,j=[1,1],k=null,q=!1,N=null;return l.separation=function(n){return arguments.length?(S=n,Y=null,l):S},l.spacing=function(n){return arguments.length?(Y=n,S=null,l):Y},l.size=function(n){return arguments.length?(j=n,k=null,l):j},l.nodeSize=function(n){return arguments.length?(k=n,j=null,l):k},l.setNodeSizes=function(n){return arguments.length?(q=n,l):q},l.rootXSize=function(){return N?N.x_size:null},r(l,w)}});
/*view.mindmap.js*/
!function(t,e){"function"==typeof define&&define.amd?define(["d3"],e):"object"==typeof exports?module.exports=e(require("d3")):t.markmap=e(t.d3)}(this,function(t){function e(t,n){var r=e.canvas||(e.canvas=document.createElement("canvas")),a=r.getContext("2d");a.font=n;var i=a.measureText(t);return i.width}function n(t,e,r){t.branch=e,t.children&&t.children.forEach(function(t){n(t,e,r)})}function r(t){t.children&&(t.children.forEach(r),t.children=[{name:"",dummy:!0,children:t.children}])}function a(t,e){t.name.length>e&&(t.name=t.name.slice(0,e-1)+"…"),t.children&&t.children.forEach(function(t){a(t,e)})}function i(t,e,n){return this instanceof i?void this.init(t,e,n):new i(t,e,n)}var o=Object.assign||function(t,e){for(var n in e)e.hasOwnProperty(n)&&(t[n]=e[n]);return t},s={nodeHeight:20,nodeWidth:180,nodePadding:12,spacingVertical:5,spacingHorizontal:60,truncateLabels:0,duration:750,layout:"tree",color:"gray",linkShape:"diagonal",renderer:"boxed"};return o(i.prototype,{getInitialState:function(){return{zoomScale:1,zoomTranslate:[0,0],autoFit:!0,depthMaxSize:{},yByDepth:{},nodeFont:"10px sans-serif"}},presets:{"default":s,colorful:o(o({},s),{nodeHeight:10,renderer:"basic",color:"category20",nodePadding:6})},helperNames:["layout","linkShape","color"],layouts:{tree:function(n){return t.layout.flextree().setNodeSizes(!0).nodeSize(function(t){var r=t.dummy?n.state.spacingHorizontal:e(t.name,n.state.nodeFont);return!t.dummy&&r>0&&(r+=2*n.state.nodePadding),[n.state.nodeHeight,r]}).spacing(function(t,e){return t.parent==e.parent?n.state.spacingVertical:2*n.state.spacingVertical})}},linkShapes:{diagonal:function(){return t.svg.diagonal().projection(function(t){return[t.y,t.x]})},bracket:function(){return function(t){return"M"+t.source.y+","+t.source.x+"V"+t.target.x+"H"+t.target.y}}},colors:o({gray:function(){return function(){return"#929292"}}},t.scale),init:function(e,n,r){r=r||{},e=e.datum?e:t.select(e),this.helpers={},this.i=0;var a=this.state=this.getInitialState();this.set(this.presets[r.preset||"default"]),a.height=e.node().getBoundingClientRect().height,a.width=e.node().getBoundingClientRect().width,this.set(r),e.on("mousedown",function(){var e=t.event;2===e.button&&e.stopImmediatePropagation()});var i=this.zoom=t.behavior.zoom().on("zoom",function(){this.updateZoom(t.event.translate,t.event.scale)}.bind(this));this.svg=e.call(i).append("g"),this.updateZoom(a.zoomTranslate,a.zoomScale),this.setData(n),this.update(a.root),(void 0===r.autoFit||null===r.autoFit)&&(a.autoFit=!1)},updateZoom:function(t,e){var n=this.state;n.zoomTranslate=t,n.zoomScale=e,this.zoom.translate(n.zoomTranslate).scale(n.zoomScale),this.svg.attr("transform","translate("+n.zoomTranslate+") scale("+n.zoomScale+")")},set:function(t){t.preset&&this.set(this.presets[t.preset]);var e=this.state,n=this.helpers;return this.helperNames.forEach(function(r){(!n[r]||t[r]&&t[r]!==e[r])&&(n[r]=this[r+"s"][t[r]||e[r]](this))}.bind(this)),o(e,t||{}),this},setData:function(t){var e=this.state;e.truncateLabels&&a(t,e.truncateLabels),t.children&&t.children.forEach(function(t,r){n(t,r,e)});var e=this.state;return e.root=t,e.root.x0=e.height/2,e.root.y0=0,this},update:function(e){var n=this.state;e=e||n.root;var r=this.layout(n);if(n.autoFit){var a=t.min(r.nodes,function(t){return t.x}),i=t.min(r.nodes,function(t){return t.y}),o=t.max(r.nodes,function(t){return t.x}),s=t.max(r.nodes,function(t){return t.y+t.y_size}),c=o-a,u=s-i,l=Math.min(n.height/c,n.width/u,1),h=[(n.width-u*l)/2-i*l,(n.height-c*l)/2-a*l];this.updateZoom(h,l)}return this.render(e,r.nodes,r.links),this},layout:function(t){var e=this.helpers.layout;"bracket"!==t.linkShape&&r(t.root);var n=e.nodes(t.root).reverse();n=n.filter(function(t){return!t.dummy}),n.forEach(function(t){t.children&&1===t.children.length&&t.children[0].dummy&&(t.children=t.children[0].children),t.parent&&t.parent.dummy&&(t.parent=t.parent.parent)}),"bracket"===t.linkShape&&n.forEach(function(e){e.y+=e.depth*t.spacingHorizontal});var a=e.links(n);return{nodes:n,links:a}},render:function(t,e,n){this.renderers[this.state.renderer].call(this,t,e,n)},renderers:{boxed:function(e,n,r){var a=this.svg,i=this.state,o=this.helpers.color;this.renderers.basic.call(this,e,n,r);var s=a.selectAll("g.markmap-node");s.select("rect").attr("y",-i.nodeHeight/2).attr("rx",10).attr("ry",10).attr("height",i.nodeHeight).attr("fill",function(e){return t.rgb(o(e.branch)).brighter(1.2)}).attr("stroke",function(t){return o(t.branch)}).attr("stroke-width",1),s.select("text").attr("dy","3"),a.selectAll("path.markmap-link").attr("stroke-width",1)},basic:function(t,e,n){function r(t){var e=t.depth;return""!==t.name&&t.children&&1===t.children.length&&""===t.children[0].name&&(e+=1),Math.max(6-2*e,1.5)}var a=this.svg,i=this.state,o=this.helpers.color,s=this.helpers.linkShape,c=a.selectAll("g.markmap-node").data(e,function(t){return t.id||(t.id=++this.i)}.bind(this)),u=c.enter().append("g").attr("class","markmap-node").attr("transform",function(e){return"translate("+(t.y0+t.y_size-e.y_size)+","+t.x0+")"}).on("click",this.click.bind(this));u.append("rect").attr("class","markmap-node-rect").attr("y",function(t){return-r(t)/2}).attr("x",function(t){return t.y_size}).attr("width",0).attr("height",r).attr("fill",function(t){return o(t.branch)}),u.append("circle").attr("class","markmap-node-circle").attr("cx",function(t){return t.y_size}).attr("stroke",function(t){return o(t.branch)}).attr("r",1e-6).style("fill",function(t){return t._children?o(t.branch):""}),u.append("text").attr("class","markmap-node-text").attr("x",function(t){return t.y_size}).attr("dy","-5").attr("text-anchor",function(t){return"start"}).text(function(t){return t.name}).style("fill-opacity",1e-6);var l=c.transition().duration(i.duration).attr("transform",function(t){return"translate("+t.y+","+t.x+")"});l.select("rect").attr("x",-1).attr("width",function(t){return t.y_size+2}),l.select("circle").attr("r",4.5).style("fill",function(t){return t._children?o(t.branch):""}).style("display",function(t){var e=t.children||t._children;return e?"inline":"none"}),l.select("text").attr("x",10).style("fill-opacity",1);var h=c.exit().transition().duration(i.duration).attr("transform",function(e){return"translate("+(t.y+t.y_size-e.y_size)+","+t.x+")"}).remove();h.select("rect").attr("x",function(t){return t.y_size}).attr("width",0),h.select("circle").attr("r",1e-6),h.select("text").style("fill-opacity",1e-6).attr("x",function(t){return t.y_size});var d=a.selectAll("path.markmap-link").data(n,function(t){return t.target.id});d.enter().insert("path","g").attr("class","markmap-link").attr("stroke",function(t){return o(t.target.branch)}).attr("stroke-width",function(t){return r(t.target)}).attr("d",function(e){var n={x:t.x0,y:t.y0+t.y_size};return s({source:n,target:n})}),d.transition().duration(i.duration).attr("d",function(t){var e={x:t.source.x,y:t.source.y+t.source.y_size},n={x:t.target.x,y:t.target.y};return s({source:e,target:n})}),d.exit().transition().duration(i.duration).attr("d",function(e){var n={x:t.x,y:t.y+t.y_size};return s({source:n,target:n})}).remove(),e.forEach(function(t){t.x0=t.x,t.y0=t.y})}},click:function(t){t.children?(t._children=t.children,t.children=null):(t.children=t._children,t._children=null),this.update(t)}}),i});
/*parse.markdown.js*/
!function(){window.parseMarkdown=function(e,s){s=s||{},parseLists=s.lists!==!1;var l=new Remarkable;l.block.ruler.enable(["deflist"]);for(var t=l.parse(e,{}),n=[],a=0,i=0;i<t.length;i+=1)if("heading_open"===t[i].type)a=t[i].hLevel,n.push({depth:a,line:t[i].lines[0],name:t[i+1].content||""}),i+=1;else if(parseLists)switch(t[i].type){case"bullet_list_open":case"dl_open":case"ordered_list_open":case"bullet_list_close":case"dl_close":case"ordered_list_close":a-=2;break;case"list_item_open":case"dt_open":}return n}}();
/*transform.headings.js*/
!function(){function e(n,h){return n.depth-=h,n.children&&1===n.children.length&&n.children[0].autoCollapse&&(n.children=n.children[0].children,h+=1),n.children&&(n.children=n.children.map(function(n){return n.autoCollapse&&n.children&&1===n.children.length?e(n.children[0],h+1):e(n,h)})),n.autoCollapse&&delete n.autoCollapse,n}window.transformHeadings=function(n){var h,l={name:"root",depth:0,children:[]},r=l,d=[];return n.forEach(function(e){for(;e.depth<r.depth+1;)r=d.pop();for(;e.depth>r.depth+1;)r.children&&0!==r.children.length||(h={name:"",depth:r.depth+1},r.children=r.children||[],r.children.push(h)),d.push(r),r=r.children[r.children.length-1];r.children=r.children||[],r.children.push(e)}),l=e(l,0),1===l.children.length&&(l=l.children[0]),l}}();
/*init.js*/
!function(){function n(){var n=document.createElement("style");n.textContent=".markmap-node {cursor: pointer;}.markmap-node-circle {fill: #fff;stroke-width: 1.5px;}.markmap-node-text {fill:  #000;font: 10px sans-serif;}.markmap-link {fill: none;}",document.head.appendChild(n)}window.markmapview=function(e,a){var t=parseMarkdown(a),r=transformHeadings(t);d3.json("./",function(){markmap("svg#"+e,r,{preset:"default",linkShape:"diagonal"}),n()})},window.markmapviewFromUrl=function(n,e){var a;try{a=new window.XMLHttpRequest}catch(t){return void console.error(t)}a.onreadystatechange=function(){if(4==a.readyState){var e=a.status;if(!(e>=200&&300>e))return;window.markmapview(n,a.responseText)}},a.open("GET",e),a.send(null)}}();
